        ...
        <div className="opacity">
          <div className="container">
            ...
            <form className="col-sm-12 col-lg-6">
              ...
              <button type="submit" onClick={handleSubmit} className="btn btn-green" aria-label="explore">Search</button>
            </form>
          </div>
        </div>
      </header>
          ...
          <div className="col-3 mt-5 profile profile-top">
            <div className="image">
              ...
              <div className="ms-auto next-prev">
                <button className="btn disabled next" aria-label="next" type="button"><GrFormPrevious /></button>
                <button className="btn prev" aria-label="previous" type="button"><GrFormNext /></button>
              </div>
            </div>
            ...
            <div className="col-12 col-lg-6 mt-5 left-testi">
              <div className="comment">
                ...
                <p>
                  ...
                  It was an amazing experience to have a ride for wildlife trip!”
                </p>
              </div>
